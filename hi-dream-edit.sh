...
CHECKPOINT_MODELS=(
    "https://huggingface.co/QuantStack/HiDream-E1-1-GGUF/resolve/main/HiDream_E1_1_-Q8_0.gguf"
)
...
TEXT_ENCODERS=(
    ...
    "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/blob/main/split_files/text_encoders/llama_3.1_8b_instruct_fp8_scaled.safetensors"
)
